...
type SharedInformerFactory interface {
	...
	Kubecluster() kubeclusterorg.Interface
}

func (f *sharedInformerFactory) Kubecluster() kubeclusterorg.Interface {
	return kubeclusterorg.New(f, f.namespace, f.tweakListOptions)
}
