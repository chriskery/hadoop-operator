...
import (
	v1alpha1 "github.com/chriskery/hadoop-cluster-operator/pkg/client/clientset/versioned/typed/kubecluster.org/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeKubeclusterV1alpha1 struct {
	*testing.Fake
}
