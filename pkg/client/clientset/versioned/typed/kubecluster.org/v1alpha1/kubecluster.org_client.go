...
import (
	...
	"github.com/chriskery/hadoop-operator/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type KubeclusterV1alpha1Interface interface {
	RESTClient() rest.Interface
	HadoopApplicationsGetter
...
func (c *KubeclusterV1alpha1Client) HadoopApplications(namespace string) HadoopApplicationInterface {
	return newHadoopApplications(c, namespace)
}
...
// NewForConfigAndClient creates a new KubeclusterV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*KubeclusterV1alpha1Client, error) {
	...
	return &KubeclusterV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new KubeclusterV1alpha1Client for the given config and
...
func New(c rest.Interface) *KubeclusterV1alpha1Client {
	return &KubeclusterV1alpha1Client{c}
}
