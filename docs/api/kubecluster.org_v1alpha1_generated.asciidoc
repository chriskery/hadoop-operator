...
[id="{anchor_prefix}-github-com-chriskery-hadoop-cluster-operator-pkg-apis-kubecluster-org-v1alpha1-datanodespectemplate"]
==== DataNodeSpecTemplate 
...
[id="{anchor_prefix}-github-com-chriskery-hadoop-cluster-operator-pkg-apis-kubecluster-org-v1alpha1-hdfsspecspectemplate"]
==== HDFSSpecSpecTemplate 
...
|===
| Field | Description
| *`hdfs`* __xref:{anchor_prefix}-github-com-chriskery-hadoop-cluster-operator-pkg-apis-kubecluster-org-v1alpha1-hdfsspecspectemplate[$$HDFSSpecSpecTemplate$$]__ | INSERT ADDITIONAL SPEC FIELDS - desired state of cluster Important: Run "make" to regenerate code after modifying this file
| *`dataNode`* __xref:{anchor_prefix}-github-com-chriskery-hadoop-cluster-operator-pkg-apis-kubecluster-org-v1alpha1-datanodespectemplate[$$DataNodeSpecTemplate$$]__ | 
| *`yarn`* __object (keys:YarnReplicaType, values:xref:{anchor_prefix}-github-com-chriskery-hadoop-cluster-operator-pkg-apis-kubecluster-org-v1alpha1-yarnspectemplate[$$YarnSpecTemplate$$])__ | 
|===
